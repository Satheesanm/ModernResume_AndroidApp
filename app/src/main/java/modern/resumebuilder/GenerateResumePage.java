...
public class GenerateResumePage extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.home:
            {
                        startActivity(new Intent(GenerateResumePage.this, CreateResumePage.class));
                    }

            case R.id.logout:
            {
                startActivity(new Intent(GenerateResumePage.this, Login.class));
            }
            case R.id.save:
                savePdf();
                return true;
    ...
    private void savePdf() {
        ...
        try {
            ...
            document.close();
            Toast.makeText(this,"Saved pdf at "+getFilePath(),Toast.LENGTH_LONG).show();
        }
        catch(Exception e) {
    ...
    private String getFilePath(){
        ...
        File resumeDir=contextwrapper.getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS);
        File file=new File(resumeDir, "Resume" + ".pdf");
        return file.getPath();
    }
}
